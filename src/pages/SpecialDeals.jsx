...
const SpecialDeals = () => {
    return (
        ...
        <Wrapper>
            ...
            <SpecialDealsWrapperStyled style={{ background: `url(${assets.activityBg})`, backgroundRepeat: "repeat", backgroundSize: "auto", backgroundPosition: "50% 50%", backgroundAttachment: "fixed", }}>
                <CommonInnerBanner innerBannerImage={assets.contactUsBanner} innerBannerText="Special Deals" />
                <Box className="activityWrap">
          {
            specialDealsData.map((eachData, index) => (
